...
class Root(Tk):
    def __init__(self):
        ...
        self.frame_outputs = ttk.LabelFrame(self, text =
                                'Рассчитанные параметры:', labelanchor="n")
...
class Rec:
    ...
    def input_widgets(self):
        ...
        self.root.label_rec = ttk.Label(self.root.frame_inputs, text =
                                                        'Рекомендация')
        ...
        self.root.combobox_rec = ttk.Combobox(self.root.frame_inputs,
                                    width = 20, textvariable = self.root.rec)
        ...
        self.root.label_frequency = ttk.Label(self.root.frame_inputs, text =
                                                'Частота (f), ГГц')
        self.root.label_frequency.grid(column = 0, row = 2, sticky = E,
                                        padx = 5)
        #   Entry for frequency
        self.root.frequency = StringVar()
        self.root.entry_frequency = ttk.Entry(self.root.frame_inputs, width =
                                    10, textvariable = self.root.frequency,
        ...
        self.root.label_diameter = ttk.Label(self.root.frame_inputs, text =
                                                'Диаметр антенны (D), м')
        self.root.label_diameter.grid(column = 0, row=3, sticky = E, padx = 5)
        #   Entry for diameter
        self.root.diameter = StringVar()
        self.root.entry_diameter = ttk.Entry(self.root.frame_inputs, width =
                                        10, textvariable = self.root.diameter,
                        validate = 'all', validatecommand = (self.vcmd, '%P'))
    ...
    def output_widgets(self):
        ...
        self.root.label_offaxis_gain.grid(column = 0, row = 0, sticky = E,
                                                    padx = 5, pady = (0, 10))
        ...
        #   Label for D/λ entry
        self.root.label_dw = ttk.Label(self.root.frame_add_out, text =
                                        'Отношение D/\u03BB')
    ...
    class Equations:
        ...
        def __init__(self, inputs):
            ...
            self.phi, self.f, self.d = inputs[:3]  # off-axis angle (°),
                                       # frequency (GHz), antenna diameter (m)
            self.g = ''
            self.add_params()
            self.offaxis_gain()
        ...
        def add_params(self):
            ...
            # длина волны, мм
            self.wr = (round(10 ** 3 * self.w, 2) if type(self.w) ==
                        float else self.w)
...
class AP8(Rec):
    def output_widgets(self):
        ...
        self.root.label_gmax = ttk.Label(self.root.frame_add_out, text =
                                    'Макс. коэффициент усиления (Gmax), дБ')
        ...
        #   Label for G1 entry
        self.root.label_g1 = ttk.Label(self.root.frame_add_out, text =
                                        'Усиление 1-й бок. лепестка (G1), дБ')
        ...
        #   Label for φm
        self.root.label_phim = ttk.Label(self.root.frame_add_out, text =
                                'Внеосевой угол начала G1 (\u03C6m), \u00b0')
        ...
        #   Label for φr
        self.root.label_phir = ttk.Label(self.root.frame_add_out, text =
                                'Внеосевой угол конца G1 (\u03C6r), \u00b0')
        ...
        #   Label for φb
        self.root.label_phib = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол \u03C6b, \u00b0')
    ...
    class Equations(Rec.Equations):
        ...
        def offaxis_gain(self):
            if self.phi == 0:
                ...
                self.g = self.gmax - 2.5 * 10 ** (-3) * (self.dw *
                                                        self.phi) ** 2
...
class AP30_97(AP8):
    def input_widgets(self):
        ...
        #   Label for eta entry
        self.root.label_eta = ttk.Label(self.root.frame_inputs, text =
                                'Коэфф. использ. поверхн. антенны (\u03B7)')
        ...
        self.root.entry_eta = ttk.Entry(self.root.frame_inputs, width = 10,
                    ...
                    validate = 'key', validatecommand = (self.eta_vcmd, '%P'))
    ...
    def output_widgets(self):
        ...
        #   Label for 0.25*φ0
        self.root.label_z25phi0 = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол 0.25*\u03C60, \u00b0')
        self.root.label_z25phi0.grid(column = 0, row = 7, sticky = E, padx = 5)
        #   Entry for 0.25*φ0
        self.root.entry_z25phi0 = ttk.Entry(self.root.frame_add_out,
                                            width = 10)
        self.root.entry_z25phi0.grid(column = 1, row = 7, sticky = W)

        #   Label for 0.44*φ0
        self.root.label_z44phi0 = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол 0.44*\u03C60, \u00b0')
        self.root.label_z44phi0.grid(column = 0, row = 8, sticky = E, padx = 5)
        #   Entry for 0.44*φ0
        self.root.entry_z44phi0 = ttk.Entry(self.root.frame_add_out,
                                            width = 10)
        self.root.entry_z44phi0.grid(column = 1, row = 8, sticky = W)

        #   Label for φ0
        self.root.label_phi0 = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол \u03C60, \u00b0')
        ...
        #   Label for φ1
        self.root.label_phi1 = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол \u03C61, \u00b0')
        ...
        #   Label for φ2
        self.root.label_phi2 = ttk.Label(self.root.frame_add_out, text =
                                        'Внеосевой угол \u03C62, \u00b0')
        ...
        #   Label for S
        self.root.label_s = ttk.Label(self.root.frame_add_out, text =
                                        'Коэффициент C, дБ')
...
class S465(Rec):
    def input_widgets(self):
        ...
        self.root.label_date = ttk.Label(self.root.frame_inputs, text =
                                        'Дата заявления сети: ')
        ...
        self.root.radio_after = ttk.Radiobutton(self.root.date_frame, text =
                'После 1993 г.', value = 1, variable = self.root.after_before)
        self.root.radio_after.grid(column = 0, row = 0)
        self.root.radio_after.invoke()

        self.root.radio_before = ttk.Radiobutton(self.root.date_frame, text =
                    'До 1993 г.', value = 0, variable = self.root.after_before)
        self.root.radio_before.grid(column = 1, row = 0)

        self.root.label_tx_rx = ttk.Label(self.root.frame_inputs, text =
        ...
        self.root.radio_tx = ttk.Radiobutton(self.root.frame_tx_rx, text =
                            'Передача', value = 1, variable = self.root.tx_rx)
        self.root.radio_tx.grid(column = 0, row = 0)
        self.root.radio_tx.invoke()

        self.root.radio_rx = ttk.Radiobutton(self.root.frame_tx_rx, text =
                                'Прием', value = 0, variable = self.root.tx_rx)
        self.root.radio_rx.grid(column = 1, row = 0)

    def output_widgets(self):

        self.root.label_phimin = ttk.Label(self.root.frame_add_out, text =
                            'Минимальный внеосевой угол (\u03C6min), \u00b0')
    ...
    class Equations(Rec.Equations):
        def __init__(self, inputs):
            self.ab = inputs[3]
# ab = True, если земная станция принадлежит сети, координируемой после 1993 г.
            self.tr = inputs[4]
# tr = True, если направление излучения - передача
        ...
        def add_params(self):
            ...
            if (2 <= self.f <= 31):
                if (self.ab == True or self.dw > 100):
                    if (self.tr == True or self.dw >= 33.3):
                        if self.dw >=50:
...
# ab = True, если земная станция принадлежит сети, координируемой после 1993 г.
        ...
        def add_params(self):
            ...
            if self.dw >=50:
                ...
                self.phi_min = ''
            self.phi_minr = round(self.phi_min, 2) if (
                                type(self.phi_min) == float) else self.phi_min
...
class TestEquations:
    ...
    def AP30_97(self):
        assert AP30_97.Equations([0,12.1,0.6,0.65]).outputs == [
        35.75, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        10.75, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([0.3,12.1,0.6,0.65]).outputs == [
        35.62, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        10.75, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([1,12.1,0.6,0.65]).outputs == [
        34.29, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        14.95, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([2,12.1,0.6,0.65]).outputs == [
        29.89, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        18.75, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([4,12.1,0.6,0.65]).outputs == [
        13.95, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        9.24, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([8,12.1,0.6,0.65]).outputs == [
        6.42, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        -1.58, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([50,12.1,0.6,0.65]).outputs == [
        -5, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        -5, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([100,12.1,0.6,0.65]).outputs == [
        0, 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        0, 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]
        assert AP30_97.Equations([200,12.1,0.6,0.65]).outputs == [
        '\u03C6 > 180 !', 24.78, 24.22, 35.75, 14.16, 3.84, 3.92, 22.91,
        '\u03C6 > 180 !', 0.72, 1.26, 2.86, 4.57, 10.96, -14.24]

    def AP30B(self):
        assert AP30B.Equations([0,13,2.7,0.7]).outputs == [
        49.76, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([0.3,13,2.7,0.7]).outputs == [
        46.68, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([0.8,13,2.7,0.7]).outputs == [
        30.03, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([10,13,2.7,0.7]).outputs == [
        4.0, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([20,13,2.7,0.7]).outputs == [
        -3.5, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([40,13,2.7,0.7]).outputs == [
        -8.05, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([100,13,2.7,0.7]).outputs == [
        -10, 23.06, 117.08, 49.76, 30.03, 0.76]
        assert AP30B.Equations([200,13,2.7,0.7]).outputs == [
        '\u03C6 > 180 !', 23.06, 117.08, 49.76, 30.03, 0.76]

    def AP7(self):
        assert AP7.Equations([0,14,0.6]).outputs == [
        'D/\u03BB < 35 !', 21.41, 28.02, 'D/\u03BB < 35 !', 'D/\u03BB < 35 !',
        'D/\u03BB < 35 !', 'D/\u03BB < 35 !', 'D/\u03BB < 35 !']

        assert AP7.Equations([0,14,3]).outputs == [
        50.63, 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]
        assert AP7.Equations([0.3,14,3]).outputs == [
        46.21, 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]
        assert AP7.Equations([0.7,14,3]).outputs == [
        31.2, 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]
        assert AP7.Equations([20,14,3]).outputs == [
        -3.53, 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]
        assert AP7.Equations([100,14,3]).outputs == [
        -10, 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]
        assert AP7.Equations([200,14,3]).outputs == [
        '\u03C6 > 180 !', 21.41, 140.1, 50.63, 31.2, 0.63, 0.82, 36]

        assert AP7.Equations([0,14,1]).outputs == [
        41.09, 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]
        assert AP7.Equations([1,14,1]).outputs == [
        35.63, 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]
        assert AP7.Equations([2,14,1]).outputs == [
        20.73, 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]
        assert AP7.Equations([20,14,1]).outputs == [
        -3.53, 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]
        assert AP7.Equations([100,14,1]).outputs == [
        -10, 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]
        assert AP7.Equations([200,14,1]).outputs == [
        '\u03C6 > 180 !', 21.41, 46.7, 41.09, 20.73, 1.93, 2.14, 36]

    def AP8(self):
        assert AP8.Equations([0,14,3]).outputs == [
        50.63, 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]
        assert AP8.Equations([0.3,14,3]).outputs == [
        46.21, 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]
        assert AP8.Equations([0.7,14,3]).outputs == [
        34.2, 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]
        assert AP8.Equations([20,14,3]).outputs == [
        -0.53, 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]
        assert AP8.Equations([100,14,3]).outputs == [
        -10, 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]
        assert AP8.Equations([200,14,3]).outputs == [
        '\u03C6 > 180 !', 21.41, 140.1, 50.63, 34.2, 0.58, 0.82, 48]

        assert AP8.Equations([0,14,1]).outputs == [
        41.09, 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]
        assert AP8.Equations([0.8,14,1]).outputs == [
        37.6, 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]
        assert AP8.Equations([2,14,1]).outputs == [
        27.04, 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]
        assert AP8.Equations([20,14,1]).outputs == [
        2.78, 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]
        assert AP8.Equations([100,14,1]).outputs == [
        -6.69, 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]
        assert AP8.Equations([200,14,1]).outputs == [
        '\u03C6 > 180 !', 21.41, 46.7, 41.09, 27.04, 1.61, 2.14, 48]

    def S465(self):
        assert S465.Equations([1,14,1,True,True]).outputs == [
        '\u03C6 < \u03C6_min !', 21.41, 46.7, 2]
        assert S465.Equations([3,14,1,True,True]).outputs == [
        20.07, 21.41, 46.7, 2]
        assert S465.Equations([49,14,1,True,True]).outputs == [
        -10, 21.41, 46.7, 2]
        assert S465.Equations([181,14,1,True,True]).outputs == [
        '\u03C6 > 180 !', 21.41, 46.7, 2]
        assert S465.Equations([1,14,3,True,True]).outputs == [
        32, 21.41, 140.1, 1]
        assert S465.Equations([3,14,3,True,True]).outputs == [
        20.07, 21.41, 140.1, 1]
        assert S465.Equations([49,14,3,True,True]).outputs == [
        -10, 21.41, 140.1, 1]
        assert S465.Equations([181,14,3,True,True]).outputs == [
        '\u03C6 > 180 !', 21.41, 140.1, 1]

        assert S465.Equations([1,14,1,False,True]).outputs == [
        '\u03C6 < \u03C6_min !', 21.41, 46.7, 2.14]
        assert S465.Equations([3,14,1,False,True]).outputs == [
        23.38, 21.41, 46.7, 2.14]
        assert S465.Equations([49,14,1,False,True]).outputs == [
        -6.69, 21.41, 46.7, 2.14]
        assert S465.Equations([181,14,1,False,True]).outputs == [
        '\u03C6 > 180 !', 21.41, 46.7, 2.14]
        assert S465.Equations([1,14,3,False,True]).outputs == [
        32, 21.41, 140.1, 1]
        assert S465.Equations([3,14,3,False,True]).outputs == [
        20.07, 21.41, 140.1, 1]
        assert S465.Equations([49,14,3,False,True]).outputs == [
        -10, 21.41, 140.1, 1]
        assert S465.Equations([181,14,3,False,True]).outputs == [
        '\u03C6 > 180 !', 21.41, 140.1, 1]

        assert S465.Equations([1,3.4,1,True,False]).outputs == [
        '\u03C6 < \u03C6_min !', 88.17, 11.34, 2.5]
        assert S465.Equations([3,3.4,1,True,False]).outputs == [
        20.07, 88.17, 11.34, 2.5]
        assert S465.Equations([49,3.4,1,True,False]).outputs == [
        -10, 88.17, 11.34, 2.5]
        assert S465.Equations([181,3.4,1,True,False]).outputs == [
        '\u03C6 > 180 !', 88.17, 11.34, 2.5]
        assert S465.Equations([1,3.4,3,True,False]).outputs == [
        '\u03C6 < \u03C6_min !', 88.17, 34.02, 2.44]
        assert S465.Equations([3,3.4,3,True,False]).outputs == [
        20.07, 88.17, 34.02, 2.44]
        assert S465.Equations([49,3.4,3,True,False]).outputs == [
        -10, 88.17, 34.02, 2.44]
        assert S465.Equations([181,3.4,3,True,False]).outputs == [
        '\u03C6 > 180 !', 88.17, 34.02, 2.44]

    def S580(self):
        assert S580.Equations([1,14,1,True]).outputs == [
        'D/\u03BB < 50 !', 21.41, 46.7, '']
        assert S580.Equations([1,14,1.1,True]).outputs == [
        35.32, 21.41, 51.37, 1.95]
        assert S580.Equations([3,14,1.1,True]).outputs == [
        17.07, 21.41, 51.37, 1.95]
        assert S580.Equations([21,14,1.1,True]).outputs == [
        -1.06, 21.41, 51.37, 1.95]
        assert S580.Equations([27,14,1.1,True]).outputs == [
        -3.78, 21.41, 51.37, 1.95]
        assert S580.Equations([49,14,1.1,True]).outputs == [
        -10, 21.41, 51.37, 1.95]
        assert S580.Equations([181,14,1.1,True]).outputs == [
        '\u03C6 > 180 !', 21.41, 51.37, 1.95]
